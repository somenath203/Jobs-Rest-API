...
If you don't follow the above steps after login and directly try to create or edit or fetch jobs, then we will get this error :- "errorMsg": "Authentication Error | No headers found"
